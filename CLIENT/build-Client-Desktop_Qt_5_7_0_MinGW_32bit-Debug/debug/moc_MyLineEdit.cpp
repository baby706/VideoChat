...
QT_MOC_LITERAL(1, 11, 15), // "LineEditClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 11) // "MyLineEdit*"

    },
    "MyLineEdit\0LineEditClicked\0\0MyLineEdit*"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->LineEditClicked((*reinterpret_cast< MyLineEdit*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyLineEdit::*_t)(MyLineEdit * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLineEdit::LineEditClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::LineEditClicked(MyLineEdit * _t1)
{
